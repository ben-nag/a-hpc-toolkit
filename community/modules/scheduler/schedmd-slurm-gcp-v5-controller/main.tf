...
module "slurm_controller_instance" {
  source = "github.com/ben-nag/a-slurm-gcp.git//terraform/slurm_cluster/modules/slurm_controller_instance?ref=5.10.6"
...
module "slurm_controller_template" {
  source = "github.com/ben-nag/a-slurm-gcp.git//terraform/slurm_cluster/modules/slurm_instance_template?ref=5.10.6"
